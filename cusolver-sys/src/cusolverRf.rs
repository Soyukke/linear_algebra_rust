...
pub const cusolverRfResetValuesFastMode_t_CUSOLVERRF_RESET_VALUES_FAST_MODE_OFF:
    cusolverRfResetValuesFastMode_t = 0;
pub const cusolverRfResetValuesFastMode_t_CUSOLVERRF_RESET_VALUES_FAST_MODE_ON:
    cusolverRfResetValuesFastMode_t = 1;
pub type cusolverRfResetValuesFastMode_t = ::std::os::raw::c_uint;
pub const cusolverRfMatrixFormat_t_CUSOLVERRF_MATRIX_FORMAT_CSR: cusolverRfMatrixFormat_t = 0;
pub const cusolverRfMatrixFormat_t_CUSOLVERRF_MATRIX_FORMAT_CSC: cusolverRfMatrixFormat_t = 1;
pub type cusolverRfMatrixFormat_t = ::std::os::raw::c_uint;
pub const cusolverRfUnitDiagonal_t_CUSOLVERRF_UNIT_DIAGONAL_STORED_L: cusolverRfUnitDiagonal_t = 0;
pub const cusolverRfUnitDiagonal_t_CUSOLVERRF_UNIT_DIAGONAL_STORED_U: cusolverRfUnitDiagonal_t = 1;
pub const cusolverRfUnitDiagonal_t_CUSOLVERRF_UNIT_DIAGONAL_ASSUMED_L: cusolverRfUnitDiagonal_t = 2;
pub const cusolverRfUnitDiagonal_t_CUSOLVERRF_UNIT_DIAGONAL_ASSUMED_U: cusolverRfUnitDiagonal_t = 3;
pub type cusolverRfUnitDiagonal_t = ::std::os::raw::c_uint;
pub const cusolverRfFactorization_t_CUSOLVERRF_FACTORIZATION_ALG0: cusolverRfFactorization_t = 0;
pub const cusolverRfFactorization_t_CUSOLVERRF_FACTORIZATION_ALG1: cusolverRfFactorization_t = 1;
pub const cusolverRfFactorization_t_CUSOLVERRF_FACTORIZATION_ALG2: cusolverRfFactorization_t = 2;
pub type cusolverRfFactorization_t = ::std::os::raw::c_uint;
pub const cusolverRfTriangularSolve_t_CUSOLVERRF_TRIANGULAR_SOLVE_ALG1:
    cusolverRfTriangularSolve_t = 1;
pub const cusolverRfTriangularSolve_t_CUSOLVERRF_TRIANGULAR_SOLVE_ALG2:
    cusolverRfTriangularSolve_t = 2;
pub const cusolverRfTriangularSolve_t_CUSOLVERRF_TRIANGULAR_SOLVE_ALG3:
    cusolverRfTriangularSolve_t = 3;
pub type cusolverRfTriangularSolve_t = ::std::os::raw::c_uint;
pub const cusolverRfNumericBoostReport_t_CUSOLVERRF_NUMERIC_BOOST_NOT_USED:
    cusolverRfNumericBoostReport_t = 0;
pub const cusolverRfNumericBoostReport_t_CUSOLVERRF_NUMERIC_BOOST_USED:
    cusolverRfNumericBoostReport_t = 1;
pub type cusolverRfNumericBoostReport_t = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
