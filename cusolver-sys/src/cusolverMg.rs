...
pub const cusolverMgGridMapping_t_CUDALIBMG_GRID_MAPPING_ROW_MAJOR: cusolverMgGridMapping_t = 1;
pub const cusolverMgGridMapping_t_CUDALIBMG_GRID_MAPPING_COL_MAJOR: cusolverMgGridMapping_t = 0;
#[doc = " \\beief This enum decides how 1D device Ids (or process ranks) get mapped to a 2D grid."]
pub type cusolverMgGridMapping_t = ::std::os::raw::c_uint;
#[doc = " \\brief Opaque structure of the distributed grid"]
pub type cudaLibMgGrid_t = *mut ::std::os::raw::c_void;
#[doc = " \\brief Opaque structure of the distributed matrix descriptor"]
...
extern "C" {
    #[doc = " \\brief Releases the allocated resources related to the distributed matrix descriptor.\n \\param[in] desc the opaque data strcuture that holds the descriptor\n \\returns the status code"]
